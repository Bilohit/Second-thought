...
export const PANEL_W = 288; // = CAPSULE_OPEN_W (6 ALL_TARGETS × 44 + 24 pad); the compactPanel.test.ts equality lock forces this to track when a target is added/removed
