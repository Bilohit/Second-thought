 ...
 *  - No motion beyond what already ships (SegmentedToggle's own pill
 *    transition, the shared `.btn-hover` utility) — FLIP re-order, the
 *    suggestion's collapse-on-dismiss, and the sort-icon swap are Task 6.
 *    Standing rule: no new easing curve or duration may be invented here.
...
export default function ProjectsRail({
  ...
  return (
    <div style={railStyle}>
      ...
      <style>{`
        .pr-tile { transition: background 160ms cubic-bezier(0.16,1,0.3,1), color 160ms cubic-bezier(0.16,1,0.3,1); }
        ...
        .pr-sg-create { transition: background 160ms cubic-bezier(0.16,1,0.3,1), transform 120ms cubic-bezier(0.16,1,0.3,1); }
        ...
        .pr-sg-rename { transition: background 160ms cubic-bezier(0.16,1,0.3,1), border-color 160ms cubic-bezier(0.16,1,0.3,1), transform 120ms cubic-bezier(0.16,1,0.3,1); }
        ...
        .pr-sg-dismiss { transition: color 200ms cubic-bezier(0.16,1,0.3,1), border-color 200ms cubic-bezier(0.16,1,0.3,1), background 200ms cubic-bezier(0.16,1,0.3,1); }
        .pr-sg-dismiss:hover, .pr-sg-dismiss:focus-visible { color: var(--red); border-color: var(--red); background: rgba(255,100,103,0.12); outline: none; }
      ...
      {/* band 2 — the ONLY band that scrolls. */}
      <div style={railScrollStyle}>
        {mode === "projects" ? (
          ...
          <div style={tilesGridStyle} role="listbox" aria-label="Projects">
            {projects.map((p) => {
      ...
      {suggestion && (
        <div style={suggWrapStyle}>
          <div style={suggBoxStyle}>
            ...
            <div style={suggNameStyle}>{suggestion.name}</div>
            <div style={suggFactStyle}>{suggestion.fact}</div>
